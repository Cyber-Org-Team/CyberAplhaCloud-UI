...
function one_business_blocks_gettingstarted() {
	add_theme_page( esc_html__('Theme Installation', 'one-business-blocks'), esc_html__('Theme Installation', 'one-business-blocks'), 'edit_theme_options', 'one-business-blocks-guide-page', 'one_business_blocks_guide');
}
