...
function one_business_blocks_setup() {
    ...
    // Enable page attributes for custom templates
            ...
            <div class="notice notice-info is-dismissible" data-notice="get_started_notice">
                <div class="notice-div">
                    ...
                    <div class="notice-buttons-box">
                        ...
                        <a class="button-primary theme-install" href="themes.php?page=one-business-blocks-guide-page"><?php _e('Theme Installation', 'one-business-blocks'); ?></a> 
                    </div>
                </div>
            </div>
        <?php
