...
/**
 * Title: Banner
 * Slug: cyber-alpha-blocks/banner
 * Categories: cyber-alpha-blocks, banner
 */
?>
...
<!-- <h2 class="wp-block-heading has-text-align-center has-white-color has-text-color has-link-color" style="text-transform:uppercase"><?php esc_html_e('We are a leading consulting firm dedicated to transforming businesses through strategic insights and innovative solutions.','one-business-blocks'); ?></h2> -->
<!-- /wp:heading -->
...
<p class="has-text-align-center has-white-color has-text-color has-link-color"><?php esc_html_e('We are a leading consulting firm dedicated to transforming businesses through strategic insights and innovative solutions. Our expertise drives growth, efficiency, and long-term success for our clients.','one-business-blocks'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
