...
/**
 * Title: Header
 * Slug: cyber-alpha-blocks/header
 * Categories: cyber-alpha-blocks, header
 */
?>
...
<!-- <p class="has-white-color has-text-color has-link-color has-barlow-font-family"><?php esc_html_e('1(647) 385-7461','one-business-blocks'); ?></p> -->
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"textColor":"white","fontFamily":"barlow"} -->
<p class="has-white-color has-text-color has-link-color has-barlow-font-family"><?php esc_html_e('info@cyberalphacloud.com','one-business-blocks'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<!-- wp:social-link {"url":"https://www.linkedin.com/company/cyberalphacloud","service":"linkedin"} /--></ul>
<!-- /wp:social-links --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<!-- wp:navigation-link {"label":"About","type":"","url":"/#about-us","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Project","type":"","url":"/#ourskills","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Contact","type":"","url":"/contact","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Careers","type":"","url":"/careers","kind":"custom","isTopLevelLink":true} /-->
